...
namespace SwissAcademic.Crm.Web.Query.FetchXml
{
    ...
    public partial class GetEmailDomains : GetEmailDomainsBase
    {
        /// <summary>
        ...
        public virtual string TransformText()
        {
            this.Write(" <fetch distinct=\"false\" no-lock=\"true\" mapping=\"logical\">\r\n    <entity name=\"new" +
                    "_emaildomainorcampusname\">\r\n     ");
 foreach(Enum item in EntityPropertySets.GetFullPropertySet(typeof(EmailDomain)))
          {
            this.Write("                    <attribute name=\"");
Write(EntityNameResolver.ResolveAttributeName(CrmEntityNames.EMailDomain, item.ToString()));
            this.Write("\" />\r\n                      ");
}
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public class GetEmailDomainsBase
    {
        #region Fields
